...
import QuyYeuCodeDenomQuyYeuCodeDenomDenom from './QuyYeuCode/denom/QuyYeuCode.denom.denom'
...
export default { 
  QuyYeuCodeDenomQuyYeuCodeDenomDenom: load(QuyYeuCodeDenomQuyYeuCodeDenomDenom, 'QuyYeuCode.denom.denom'),
